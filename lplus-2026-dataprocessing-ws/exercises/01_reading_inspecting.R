...
# 10. Read the same data from SPSS.
chinese_ldt_sav <- read_sav("---")

# 11. Check that the imported datasets have the same dimensions.
dim(chinese_ldt_csv)
dim(chinese_ldt_excel)
dim(chinese_ldt_sav)

# 12. Use RStudio's Import Dataset menu with data/chinese_ldt.xlsx.
